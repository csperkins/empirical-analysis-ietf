...
\setlength{\figureWidthOneColumn}{0.40\textwidth}
...
\pb{RQ1: are higher levels of the hierarchy growing or becoming more
centralised? are they associated with an increased domination of the
conversation?}
...
\pb{RQ2: What is the association between the organisation hierarchy and
general communication patterns?}
...
\pb{RQ3: How do people with differing roles communicate with each other?
Does information flow ``up" or ``down" the hierarchy?} 
...
\pb{RQ4: What is the impact that individuals have on their direct contacts'
activity over time? How does this vary across hierarchy level?} 
