...
The availability of this data gives a unique opportunity to explore the
development of the Internet. Standards development is an inherently social
and political process \cite{RFC2026,RFC7282}, requiring cooperation and
...
\begin{itemize}
  \item Section \ref{sec:background} introduces the IETF and the Internet
    Standards development process, and reviews the available data.

  \item Section \ref{sec:trends-documents} considers trends in the
    production, complexity, and correctness of IETF standards documents
    over time.

  \item Section \ref{sec:trends-demographics} moves on to consider the
    people who are involved in Internet standards development and how the
    demographics of the community have shifted over time.

  \item Section \ref{sec:org-dyn} studies the interaction between
    participants, explores who has influence and impact in the IETF and how
    that influence is evident in their activities, and the dynamics of
    communications within the IETF.

  \item Section \ref{sec:language} considers communications within the IETF
    from the perspective of language to explore whether there are
  ...
  \item Section \ref{sec:success-factors} discusses what factors lead to
    success, exploring what makes a document likely to be published as an
    RFC and what makes a successful author.

\end{itemize}

Finally, we review related work in Section \ref{sec:related} and draw some
conclusions in Section \ref{sec:conclusions}. This paper is a summary and
collation of our prior published work \cite{mcquistin:2021:characterising,
khare:2022:web-we-weave, healey:2023:power, mcquistin:2023:errare,
khare:2023:tracing, karan:2023:leda, healey:2023:power-frontiers,
barnes:2024:temporal} that is submitted to stimulate discussion.
...
accounts for a small portion (10\%) of messages. This is reasonable, since
Datatracker profiles are necessary for many of the IETF's day-to-day
activities.
...
\begin{figure}
  ...
  \caption{
    Number of active drafts over time. Internet-Drafts, the working draft
    series of the IETF, were introduced at the 13th IETF meeting in 1989.
  }
...
\S\ref{sec:success-factors:documents}, adoption is a significant
milestone.
...
of RFCs, showing how the use of normative language has evolved.
Keywords are used in RFCs to indicate the normative requirements
an RFC imposes on implementations \cite{RFC2119}. Figure~\ref{fig:keyword_usage_rates}
shows the total number of occurrences of each of the 
...
2010, indicating a growing number of requirements being,
...
however: the author pool has grown less diverse in terms of
...
a working group, comprising 11,632 drafts, and employ logistic regression to
...
\begin{enumerate}
  ...
  \item We remove collinearity by using the Variance Inflation Criterion
    (VIF), removing all features with VIF $>5$. 
...
is needed for further insights.   
...
Arkko, a former Chair of the IETF, maintains a website
...
Prior work has analysed the time evolution of important nodes in a
...
time~\cite{lacasa2022correlations}. Compared to this, we brought new
analysis techniques, that expand on the idea of tracking the evolution of
node importance, to an email list corpus.
...
less of a problem. We tested these ideas in regard to the voluntary
...
We extended this work with improved modelling, and by incorporating
...
We explored the key standardisation activities within the IETF, one of the
primary technical standards developing organisations for the Internet,
considering trends in document production, complexity, and correctness
...
\begin{enumerate}
  ...
  \item While authorship is becoming more diverse as the IETF grows, there
    ...
    representative, then further effort is clearly required to build more diverse
